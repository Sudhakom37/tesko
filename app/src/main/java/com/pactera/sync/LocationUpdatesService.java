...
public class LocationUpdatesService extends Service {
    public static final String ACTION_RESP = BuildConfig.APPLICATION_ID+"Bound Service";
    ...
    public void onCreate() {
        ...
        mLocationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                boolean b = true;
                while (b){
                    new Handler().postDelayed(() -> onNewLocation(locationResult.getLastLocation()),time*60*1000);
                    b = time != 0;
                }
                //new Handler().postDelayed(() -> onNewLocation(locationResult.getLastLocation()),time*60*1000);
    ...
    public void setTimeInterval(int timeInterval) {
        Log.i(TAG, "Requesting location updates");
        //time = timeInterval;
        UPDATE_INTERVAL_IN_MILLISECONDS = timeInterval*60*1000;
    ...
    private void createLocationRequest(long updateInterval,long fastUpdateInterval) {

        mLocationRequest.setInterval(updateInterval);
        mLocationRequest.setFastestInterval(fastUpdateInterval);
